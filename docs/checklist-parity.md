...
| 6 | Set display refresh rate | Not covered | — | Removed in the v1.1 dead-key purge; returns as a live key with the display module (see Deferred). |
| 7 | Configure HDR | Not covered | — | Removed in the v1.1 dead-key purge; returns as a live key with the display module (see Deferred). |
